...
class Qutepart(QPlainTextEdit):
    ...
    **Public methods**
    ...
    #krc: Cleanly pass keyword args to Completer without hacks (**kwargs)
    ...
    #krc: Update Completer's static word list without using hacks 
    #krc: For example, although SQL reserved words are static, ...
    #krc: ...connecting to another server may have different databases, tables, columns, etc.
    #krc: These db entity names are like the variables in Python, and useful to autocomplete.
    def updateWordList(self, WordList):
        self._completer.updateWordList(WordList)

    #krc: Update Completer's parent/child list without using hacks
    #krc: Connecting to another server may have different databases, tables, columns, etc.
    #krc: These db entity names are like the variables in Python, and useful to autocomplete.
    def updateParentChildDict(self, ParentChildDict):
        self._completer.updateParentChildDict(ParentChildDict)
